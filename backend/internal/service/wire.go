...
// ProvideAccountStandbyProbeService creates and starts proactive standby connection probes.
func ProvideAccountStandbyProbeService(
	accountRepo AccountRepository,
	...
	svc := NewAccountStandbyProbeService(accountRepo, accountTestSvc, cfg)
	svc.SetLeaderLock(lockCache, db)
	svc.Start()
	return svc
}
...
var ProviderSet = wire.NewSet(
	...
	ProvideAccountStandbyProbeService,
