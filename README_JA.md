...
> **Fork notice:** このリポジトリは `gthubtom1/sub2api-standby` です。公式インストール手順は使わないでください。詳細: [docs/DEPLOY_STANDY_EN.md](docs/DEPLOY_STANDY_EN.md)
<div align="center">
...
# アンインストール
curl -sSL https://raw.githubusercontent.com/gthubtom1/sub2api-standby/main/deploy/install.sh | sudo bash -s -- uninstall -y
```
