export default {
    accounts: {
      ...
      status: {
        ...
        standbyHealthy: 'Standby OK',
        standbyStale: 'Standby Stale',
        standbyFailed: 'Standby Failed',
        standbyUnknown: 'Not Pretested',
        standbyHealthyHint: 'Background probe passed; ready for failover ({time})',
        standbyStaleHint: 'Last probe expired; will re-warm ({time})',
        standbyFailedHint: 'Recent standby probe failed ({time})',
        standbyUnknownHint: 'Not pretested yet; may be selected cold under load',
      },
      columns: {
        name: 'Name',
        id: 'Account ID',
      ...
      bulkTest: {
        title: 'Bulk Test Connection',
        selected: '{count} account(s) selected',
        progress: 'Progress {done}/{total}',
        successCount: '{count} succeeded',
        failedCount: '{count} failed',
        concurrency: 'Concurrency',
        concurrencyHint: 'How many accounts to test in parallel. Prefer 3-10 to avoid upstream rate limits.',
        modelOptional: 'Test model (optional)',
        modelPlaceholder: 'Leave empty for platform defaults',
        modelHint: 'When multiple platforms are selected, leave empty so each account uses its default model.',
        results: 'Results',
        ...
        start: 'Start Test',
        cancel: 'Stop',
        failed: 'Bulk test failed',
        noSelection: 'Select accounts first',
        completed: 'Bulk test finished: {count} succeeded'
      },
      bulkActions: {
        selected: '{count} account(s) selected',
        ...
        testConnection: 'Bulk Test Connection',
