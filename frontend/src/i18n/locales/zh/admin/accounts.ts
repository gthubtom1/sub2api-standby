export default {
    accounts: {
      ...
      status: {
        ...
        standbyFailed: '预备失败',
        standbyUnknown: '未预热',
        standbyHealthyHint: '后台探测通过，可作为备用调度（{time}）',
        standbyStaleHint: '上次探测已过期，后台将重新预热（{time}）',
        standbyFailedHint: '最近预备探测失败（{time}）',
        standbyUnknownHint: '尚未后台预热，繁忙时可能被直接抽到',
      },
      tempUnschedulable: {
        title: '临时不可调度',
      ...
      bulkTest: {
        ...
        concurrency: '并发数',
        concurrencyHint: '同时测试的账号数，建议 3-10，过高可能触发上游限流',
        modelOptional: '测试模型（可选）',
        modelPlaceholder: '留空则用各平台默认模型',
        modelHint: '多平台混选时建议留空，由服务端按账号类型选择默认模型',
        results: '测试结果',
        onlyFailed: '只看失败',
        colName: '名称',
        colStatus: '状态',
